defmodule TrackerWeb.TaskControllerTest do
  use TrackerWeb.ConnCase

  alias Tracker.Taskfeed

  @create_attrs %{description: "some description", is_completed: true, time_taken: 42, title: "some title"}
  ...
  def fixture(:task) do
    {:ok, task} = Taskfeed.create_task(@create_attrs)
    task
  end
